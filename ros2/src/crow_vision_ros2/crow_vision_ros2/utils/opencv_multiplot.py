...
class Plotter:
	def __init__(self, plot_width, plot_height, num_plot_values, zoom):
		...
		self.color_list = [(255, 0, 0), (0, 250, 0), (0, 0, 250),
					...
					(50, 255, 0), (255, 50, 0), (0, 50, 255),
					(50, 0, 255), (255, 0, 50), (0, 255, 50),
					(50, 100, 150), (50, 150, 100), (100, 50, 150),
					(100, 150, 50), (150, 100, 50), (150, 50, 100),
					(150, 150, 150), (20, 20, 20), (220, 220, 220)]
		self.color  = []
		self.val = []
	...
	def show_plot(self, label):
		...
		for i in range(len(self.val)-1):
			for j in range(len(self.val[0])):
				cv2.line(self.plot, (i, int(self.height/2) - self.zoom*self.val[i][j]), (i+1, int(self.height/2) - self.zoom*self.val[i+1][j]), self.color[j], 1)

		#cv2.imshow(label, self.plot)
		#cv2.waitKey(1)

		cv2.imshow(label, cv2.resize(self.plot, (2*self.width, 2*self.height), interpolation = cv2.INTER_AREA))
		cv2.waitKey(1)
